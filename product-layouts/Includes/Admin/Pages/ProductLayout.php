		...
		return [
			...
			'Product Layouts' => [
				'general'        => [
					...
					'src'      => '',
					'video'    => 'https://youtu.be/Ta0e_Gn7Ink',
					'doc'      => 'https://wpkin.com/docs/general-layouts/',
				...
				'call_to_action' => [
					...
					'src'      => '',
					'video'    => 'https://youtu.be/eTjS5Nxmfyo',
					'doc'      => 'https://wpkin.com/docs/call-to-action-layouts/',
				...
				'table'          => [
					...
					'src'      => '',
					'video'    => 'https://youtu.be/PKbGSaSNrXk',
					'doc'      => 'https://wpkin.com/docs/product-table-layouts/',
				...
				'product_list'   => [
					...
					'src'      => '',
					'video'    => 'https://youtu.be/4RiKMCQTOtk',
					'doc'      => 'https://wpkin.com/docs/product-list-layouts/',
				...
				'caption'        => [
					...
					'src'      => '',
					'video'    => 'https://youtu.be/aTzL1I3uf1E',
					'doc'      => 'https://wpkin.com/docs/caption-layouts/',
				...
				'flipbox'        => [
					...
					'src'      => '',
					'video'    => 'https://youtu.be/4tLLl9atiL8',
					'doc'      => 'https://wpkin.com/docs/flipbox-layouts/',
			...
			'Addons'          => [
				'tabs'      => [
					...
					'src'      => '',
					'video'    => 'https://youtu.be/GjWPh7B6NFs',
					'doc'      => 'https://wpkin.com/docs/product-tabs-pro/',
				...
				'carousel'  => [
					...
					'src'      => '',
					'video'    => 'https://youtu.be/IFB77EbCTU0',
					'doc'      => 'https://wpkin.com/docs/product-carousel-pro/',
				...
				'filter'    => [
					...
					'src'      => '',
					'video'    => '#',
					'doc'      => 'https://wpkin.com/docs/filter-sorting-pro/',
