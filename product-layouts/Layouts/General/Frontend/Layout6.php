	...
	public function layout_render( $settings, $user ) {
		...
		if ( $query->have_posts() ) {
			...
			while ( $query->have_posts() ) {
				...
				<div class="wpte-general-layout-row wpte-product-general-style-6 wpte-swiper-slide">
					<div class="wpte-general-layout-image-area">
						...
						<div class="wpte-general-layout-product-icons wpte-general-layout-icon-right">
								...
								<div class="wpte-general-layout-icons wpte-general-layout-product-wishlist">
									<?php
									$wishlist_icon = $this->wpte_product_wishlist_render( get_the_ID(), 'icon', $settings, 'right' ); // $operator = icon, text, icontext // $IconPosition = top, right, bottom, left.
								...
								<div class="wpte-general-layout-icons wpte-general-layout-product-compare">
									<?php
									$cmopare_icon = $this->wpte_product_compare_render( get_the_ID(), 'icon', $settings, 'right' ); // $operator = icon, text, icontext // $IconPosition = top, right, bottom, left.
								...
								<div class="wpte-general-layout-icons wpte-general-layout-product-view wpte-product-layouts-quick-view">
									<?php
									$quickview_icon = $this->wpte_product_quickview_render( get_the_ID(), 'icon', $settings, 'right' ); // $operator = icon, text, icontext // $IconPosition = top, right, bottom, left.
