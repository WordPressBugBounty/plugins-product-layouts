...
class Layout3 extends Public_Render {
	...
	public function public_js() {
		wp_enqueue_style( 'wpte-general-style3', WPTE_WPL_ASSETS . 'layouts/General/css/layout3.css', null, filemtime( WPTE_WPL_PATH . 'assets/layouts/General/css/layout3.css' ), false );
	}
	...
	public function layout_render( $settings, $user ) {
		...
		$image_size       = isset( $settings['wpte_product_layout_general_style_3_image_size'] ) ? $settings['wpte_product_layout_general_style_3_image_size'] : '';
		...
		if ( $query->have_posts() ) {
			...
			while ( $query->have_posts() ) {
				...
				<div class="wpte-general-layout-row wpte-product-general-style-3 wpte-swiper-slide">
