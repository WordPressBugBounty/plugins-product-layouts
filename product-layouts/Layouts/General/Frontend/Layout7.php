 ...
 * Layout7
 */
class Layout7 extends Public_Render {
	...
	public function layout_render( $settings, $user ) {
		...
		$image_size = isset( $settings['wpte_product_layout_general_style_7_image_size'] ) ? $settings['wpte_product_layout_general_style_7_image_size'] : '';
		...
		if ( $query->have_posts() ) {
			...
			while ( $query->have_posts() ) {
				...
				<div class="wpte-general-layout-row wpte-product-general-style-7 wpte-swiper-slide">
					<div class="wpte-general-layout-image-area">
						...
						if ( $showIcons ) :
							?>
						<div class="wpte-general-layout-product-icons wpte-general-layout-icon-bottom">
								...
								<div class="wpte-general-layout-icons wpte-general-layout-product-wishlist">
									<?php
									$wishlist_icon = $this->wpte_product_wishlist_render( get_the_ID(), 'icon', $settings, 'bottom' ); // $operator = icon, text, icontext // $IconPosition = top, right, bottom, left.
								...
								<div class="wpte-general-layout-icons wpte-general-layout-product-compare">
									<?php
									$cmopare_icon = $this->wpte_product_compare_render( get_the_ID(), 'icon', $settings, 'bottom' ); // $operator = icon, text, icontext // $IconPosition = top, right, bottom, left.
								...
								<div class="wpte-general-layout-icons wpte-general-layout-product-view wpte-product-layouts-quick-view">
									<?php
									$quickview_icon = $this->wpte_product_quickview_render( get_the_ID(), 'icon', $settings, 'bottom' ); // $operator = icon, text, icontext // $IconPosition = top, right, bottom, left.
							...
							<?php endif; if ( $is_cart_icon ) : ?>
								<div class="wpte-general-layout-icons wpte-general-layout-product-cart">
									<?php
									$this->wpte_product_cart_render( get_the_ID(), 'icon', $settings, 'bottom' ); // $operator = icon, text, icontext // $IconPosition = top, right, bottom, left.
									?>
								</div>
							<?php endif; ?>
						</div>
