...
class Layout7 extends Layout {
	...
	public function register_layout() {
		...
		$this->start_section_tabs(
			'wpte-general-section-layout7-tabs',
			[
				'condition' => [
					'general',
				],
		...
		$this->start_controls_section(
			'wpte-product-general-style-7-icons',
			[
		...
		$this->add_group_control(
			'wpte-product-general-style-7-cart-icon',
			$this->style,
			[
				'type'        => Controls::CART,
		...
		// =============WISH LIST SETTINGS=====================
		$this->start_controls_section(
			'wpte-product-general-style-7-wishlist-icons',
			[
				'label'   => 'Wish List',
				'showing' => true,
			]
		...
		// =============QUICK VIEW SETTINGS=====================
		$this->start_controls_section(
			'wpte-product-general-style-7-quickview-icons-title',
			[
				'label'   => 'Quick View',
				'showing' => true,
			]
		...
		$this->add_group_control(
			'wpte-product-general-style-7-quickview-icon',
			$this->style,
			[
		...
		$this->start_controls_section(
			'wpte-product-general-style-7-compare-icons-title',
			[
		...
		$this->add_group_control(
			'wpte-product-general-style-7-compare-icon',
			$this->style,
			[
		...
		$this->wpte_tooltip_style( 'border-top-color' );
