...
class Layout3 extends Layout {
	...
	public function register_layout() {
		...
		$this->start_controls_section(
			'wpte-product-general-style-3-icons',
			[
		...
		$this->add_group_control(
			'wpte-product-general-style-3-cart-icon',
			$this->style,
			[
				'type'        => Controls::CART,
		...
		// =============WISH LIST SETTINGS=====================
		$this->start_controls_section(
			'wpte-product-general-style-3-wishlist-icons',
			[
				'label'   => 'Wish List',
				'showing' => true,
			]
		...
		// =============QUICK VIEW SETTINGS=====================
		$this->start_controls_section(
			'wpte-product-general-style-3-quickview-icons-title',
			[
				'label'   => 'Quick View',
				'showing' => true,
			]
		...
		$this->add_group_control(
			'wpte-product-general-style-3-quickview-icon',
			$this->style,
			[
		...
		$this->start_controls_section(
			'wpte-product-general-style-3-compare-icons-title',
			[
		...
		$this->add_group_control(
			'wpte-product-general-style-3-compare-icon',
			$this->style,
			[
