...
class Layout4 extends Public_Render {
	...
	public function public_js() {
		wp_enqueue_style( 'wpte-caption-style4', WPTE_WPL_ASSETS . 'layouts/Caption/css/border_reveal_effects.css', null, filemtime( WPTE_WPL_PATH . 'assets/layouts/Caption/css/border_reveal_effects.css' ), false );
	}
	...
	public function layout_render( $settings, $user ) {
		...
		$border_effect    = isset( $settings['wpte_product_layout_caption_style_4_effect'] ) ? $settings['wpte_product_layout_caption_style_4_effect'] : '';
		...
		if ( $query->have_posts() ) {
			...
			?>
			<div class="wpte-product-column wpte-product-caption-style-4-column <?php echo esc_attr( $column ); ?>">
			<?php
			while ( $query->have_posts() ) {
				...
				<div class="wpte-product-hover-style-caption wpte-swiper-slide">
					<div class="wpte-product-hover wpte-product-caption-hover wpte-product-caption-hover-style-4 wpte-product-border-<?php echo esc_attr( $border_effect ); ?>">
