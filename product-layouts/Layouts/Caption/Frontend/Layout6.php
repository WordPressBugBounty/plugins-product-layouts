...
class Layout6 extends Public_Render {
	...
	public function public_js() {
		wp_enqueue_style( 'wpte-caption-style6', WPTE_WPL_ASSETS . 'layouts/Caption/css/circle_effects.css', null, filemtime( WPTE_WPL_PATH . 'assets/layouts/Caption/css/circle_effects.css' ), false );
	}
	...
	public function layout_render( $settings, $user ) {
		...
		$circle_effect    = isset( $settings['wpte_product_layout_caption_style_6_effect'] ) ? $settings['wpte_product_layout_caption_style_6_effect'] : '';
		...
		if ( $query->have_posts() ) {
			...
			?>
			<div class="wpte-product-column wpte-product-caption-style-6-column <?php echo esc_attr( $column ); ?>">
			<?php
			while ( $query->have_posts() ) {
				...
				<div class="wpte-product-hover-style-caption wpte-swiper-slide">
					<div class="wpte-product-hover wpte-product-caption-hover wpte-product-caption-hover-style-6 wpte-product-circle-<?php echo esc_attr( $circle_effect ); ?>">
