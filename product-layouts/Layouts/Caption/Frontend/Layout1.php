...
class Layout1 extends Public_Render {
	...
	public function public_js() {
		wp_enqueue_style( 'wpte-caption-style1', WPTE_WPL_ASSETS . 'layouts/Caption/css/blinds_effects.css', null, filemtime( WPTE_WPL_PATH . 'assets/layouts/Caption/css/blinds_effects.css' ), false );
	}
	...
	public function layout_render( $settings, $user ) {
		...
		$blind_effect     = isset( $settings['wpte_product_layout_caption_style_1_effect'] ) ? $settings['wpte_product_layout_caption_style_1_effect'] : '';
