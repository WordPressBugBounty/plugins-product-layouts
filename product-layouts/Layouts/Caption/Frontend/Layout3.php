...
class Layout3 extends Public_Render {
	...
	public function public_js() {
		wp_enqueue_style( 'wpte-caption-style3', WPTE_WPL_ASSETS . 'layouts/Caption/css/book_effects.css', null, filemtime( WPTE_WPL_PATH . 'assets/layouts/Caption/css/book_effects.css' ), false );
	}
	...
	public function layout_render( $settings, $user ) {
		...
		$book_effect      = isset( $settings['wpte_product_layout_caption_style_3_effect'] ) ? $settings['wpte_product_layout_caption_style_3_effect'] : '';
		...
		if ( $query->have_posts() ) {
			...
			?>
			<div class="wpte-product-column wpte-product-caption-style-3-column <?php echo esc_attr( $column ); ?>">
			<?php
			while ( $query->have_posts() ) {
				...
				<div class="wpte-product-hover-style-caption wpte-product-hover-style-caption-overflow wpte-swiper-slide">
					<div class="wpte-product-hover wpte-product-caption-hover wpte-product-caption-hover-style-3 wpte-product-book-<?php echo esc_attr( $book_effect ); ?>">
