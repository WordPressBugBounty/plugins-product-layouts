 ...
 * Layout8
 */
class Layout8 extends Public_Render {
	...
	public function public_js() {
		wp_enqueue_style( 'wpte-caption-style8', WPTE_WPL_ASSETS . 'layouts/Caption/css/dive_effects.css', null, filemtime( WPTE_WPL_PATH . 'assets/layouts/Caption/css/dive_effects.css' ), false );
	}
	...
	public function layout_render( $settings, $user ) {
		...
		$dive_effect      = isset( $settings['wpte_product_layout_caption_style_8_effect'] ) ? $settings['wpte_product_layout_caption_style_8_effect'] : '';
		...
		if ( $query->have_posts() ) {
			...
			?>
			<div class="wpte-product-column wpte-product-caption-style-8-column <?php echo esc_attr( $column ); ?>">
			<?php
			while ( $query->have_posts() ) {
				...
				<div class="wpte-product-hover-style-caption wpte-swiper-slide">
					<div class="wpte-product-hover wpte-product-caption-hover wpte-product-caption-hover-style-8 wpte-product-<?php echo esc_attr( $dive_effect ); ?>">
